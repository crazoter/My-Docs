...
Check the table of contents and start reading the reviews from the ones with the highest quality scores (the list is currently ordered in ascending order downwards). My all-time favourites when it comes to comedy is Grand Blue and when it comes to romcoms it's Kaguya Love is War. I don't have a favourite shounen series because that genre is saturated with good stuff.
...
### Tomo-chan wa Onnanoko (Romcom) (Score: 10/10 (+0))
...
Below is the list of manga that are still ongoing, but only updated monthly / irregularly. 

### Bakarina (Harem Comedy) (Score: 8/10, (+1))
...
### Wotakoi (Josei slice-of-life romcom) (Score: 9/10 (+0))
* Synopsis: otakus
...
### Horimiya (Slice-of-life romcom) (Score: 9/10 (+1))
...
### Chitra (Isekai Reverse Harem) (Score: 9/10, (+1))
* Synopsis: Woman reborn in fantasy world and plays Civilization
* Genre: manhwa, isekai, reverse harem
...
### The Undefeatable Swordsman (Shonen) (Score: 9/10, (+2?))
...
### The Stereotypical Life of a Reincarnated Lady (Romcom) (Score: 7/10, (-1))
...
### That Girl is not just cute (romcom) (Score: 9/10, (+0))
...
### The Pharmarcy Where the Wolf Howls (josei romcom) (Score: 9/10, (+0?))
